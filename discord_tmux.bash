...
# NAME1
tmux send-keys -t real "tmux send-keys -t NAME1 'PYTHONPATH=$(pwd) python3 main/core/event_handler/discord/event_handler_discord.py' ENTER" ENTER
# NAME2
...
# NAME3
tmux send-keys -t real "tmux send-keys -t NAME3 'redis-commander' ENTER"
